...
define root view entity ZI_03_Flight
  as select from sflight
  composition [0..*] of ZI_03_Booking     as _Bookings
  association [1..1] to ZI_03_CarrierText as _CarrierText on $projection.CarrierID = _CarrierText.Carrid
{
  ...
  key fldate                as FlightDate,
      ...
      else 0 end            as FlightDateCritically,
